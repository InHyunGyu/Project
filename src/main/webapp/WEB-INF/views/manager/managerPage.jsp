...
<script>
				...
				success : function(mesa) {
					if (mesa == 0) {
						...
						for (var i = 0; i < test.length; i++) {
							...
							$('input[data-boardno |=' + test[i] + ']').parent()
									.parent().remove();
						}
					}
				}
	...
	function writingList() {
		...
		var tag4 = '';
		tag4 += '<select class="form-control" name="searchItem">'
		...
		tag4 += '</select>'
		tag4 += '<div style="display:inline-block;">'
	...
	function memberRating(ratingList) {
		...
		tag3 += '<input type="checkbox">'
		tag3 += '<div class="form-group" style="float: right;">'
		tag3 += '<select class="form-control col-md-8 " style="height: 30px; margin-right : 5px;" id="changeLevel">'
		tag3 += '<option value="beginner">beginner</option>'
		tag3 += '<option value="regular member">regular</option>'
				...
				<div class="row">
					<div class="col-lg-2">
						<div class="sidebar">
							...
							<p>
								<a href="#" onclick="writingList();">게시글</a>
							</p>
							<p>
								<a href="#" onclick="commentList()">댓글</a>
							</p>
							<p onclick="noticeList();">
								<a href="#" onclick="noticeList();">공지</a>
							</p>
							<hr class="m-t-30 m-b-30">
							<h6 class="single-portfolio-title">카페 회원</h6>
							<p>
								<a href="#" id="memberRating">등급 관리</a>
							</p>
					...
					<div class="col-lg-10">
						...
						<div class="set_list" style="width: 100%; float: right;">
									...
									<nav>
										<ul class="pagination justify-content-center">
											<li class="page-item"><a class="page-link"
												href="managerPage?currentPage=${navi.currentPage-navi.pagePerGroup}&searchItem=${searchItem}&searchWord=${searchWord}"><span
													class="fas fa-angle-left"></span></a></li>
											<c:forEach var="page" begin="${navi.startPageGroup}"
												end="${navi.endPageGroup}">
												<li class="page-item"><a class="page-link"
													href="managerPage?currentPage=${page}&searchItem=${searchItem}&searchWord=${searchWord}">${page}</a></li>
											</c:forEach>
											<li class="page-item"><a class="page-link"
												href="managerPage?currentPage=${navi.currentPage+1}&searchItem=${searchItem}&searchWord=${searchWord}"><span
		...
		<div class="off-canvas-sidebar-wrapper">
			<div class="off-canvas-header">
				<a class="off-canvas-close" href="#"><img
					src="resources/assets/images/close.png" style="height: 15px;"></a>
			</div>
