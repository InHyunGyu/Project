			...
			<div class="col-md-12 m-auto">
				<div class="table-responsive">
					...
					<div style="float: right; margin-bottom: 10px;">
						<form action="voice_weekly" method="get"> 
					...
					<nav>
						<ul class="pagination justify-content-center">
							<li class="page-item"><a class="page-link"
								href="voice_weekly?&currentPage=${navi.currentPage-navi.pagePerGroup}&searchItem=${searchItem}&searchWord=${searchWord}"><span
									class="fas fa-angle-left"></span></a></li>
							<c:forEach var="page" begin="${navi.startPageGroup}"
								end="${navi.endPageGroup}">
								<li class="page-item"><a class="page-link"
									href="voice_weekly?&currentPage=${page}&searchItem=${searchItem}&searchWord=${searchWord}">${page}</a></li>
							</c:forEach>
							<li class="page-item"><a class="page-link"
								href="voice_weekly?&currentPage=${navi.currentPage+1}&searchItem=${searchItem}&searchWord=${searchWord}"><span
