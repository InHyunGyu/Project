                            ...
                            <div class="m-b-20">
                                <form method="signup" action="POST" id="signup">
                                    <div class="form-group">
                                        <input class="form-control" type="text" name="userid" id="userid" placeholder="ID">
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" type="password" name="userpwd" id="userpwd" placeholder="Pasword">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <input class="form-control" type="text" name="userphone" id="userphone" placeholder="PhoneNumber">
                                    </div>
                                    <div> 
										<select class="form-control" id="userphone" name="userphone">
                                     ...
                                     <div class="form-group">
                                        <input class="form-control" type="text" name="userAddress" id="userAddress" placeholder="Address">
                                    </div>
                                    <div class="form-group">
